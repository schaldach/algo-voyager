...
function NavBar({selectedPage, changePage}) {
    ...
    return (
        <div className="navbar">
            <Link href='/'><div onClick={() => changePage('')} className={selectedPage===''?'selectednav':''}>Introduction</div></Link>
            ...
            <Link href='/noise'><div onClick={() => changePage('noise')} className={selectedPage==='noise'?'selectednav':''}>Noise Generation</div></Link>
        </div>
    );
}
